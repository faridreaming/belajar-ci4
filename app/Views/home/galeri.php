...
<!-- Logo & Judul -->
<div class="mt-12 md:mt-16 mb-16 flex flex-col items-center space-y-4 mx-6">
  <img src="assets/img/tk-arrayhan.png" alt="RA AR RAYHAN" class="w-40 h-40 md:w-60 md:h-60" />
...
<!-- Highlight Galeri Terbaru Slider -->
<div class="relative bg-[#A3B76D] p-4 md:p-6 mb-10 overflow-hidden">
  <div class="flex justify-between items-start">
    <h3 class="font-semibold text-lg text-[#40531B]">(Judul Galeri)</h3>
    <span id="dateTime" class="text-sm-700 text-[#40531B] font-semibold"></span>
    <!-- <span id="dateTime" class="text-gray-700 font-semibold"></span> -->
  </div>

  <!-- Tombol panah kiri -->
  <button id="scrollLeft" class="absolute left-2 top-1/2 -translate-y-1/2 z-10 bg-white text-[#40531B] font-bold text-xl rounded-full shadow-md w-10 h-10 flex items-center justify-center">
    <i class="fas fa-chevron-left"></i>
  </button>

  <!-- Slider container -->
  <div id="galeriSlider" class="flex overflow-x-auto space-x-4 scroll-smooth no-scrollbar py-4">
    <div class="flex-shrink-0 w-64 h-36 bg-gray-300 rounded"></div>
    <div class="flex-shrink-0 w-64 h-36 bg-gray-300 rounded"></div>
    <div class="flex-shrink-0 w-64 h-36 bg-gray-300 rounded"></div>
    <div class="flex-shrink-0 w-64 h-36 bg-gray-300 rounded"></div>
    <div class="flex-shrink-0 w-64 h-36 bg-gray-300 rounded"></div>
  ...
  <!-- Tombol panah kanan -->
  <button id="scrollRight" class="absolute right-2 top-1/2 -translate-y-1/2 z-10 bg-white text-[#40531B] font-bold text-xl rounded-full shadow-md w-10 h-10 flex items-center justify-center">
