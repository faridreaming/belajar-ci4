            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="judul" id="judul" class="form-control" required maxlength="128" oninput="updateCharCount('judul', 'judulCount', 128)" value="<?= old('judul'); ?>">
                        <small id="judulCount" class="form-text text-muted d-inline-block mt-2">0 / 128 karakter</small>
                    </div>

                    <div class="mb-md-0 mb-3">
                        <label for="isi" class="form-label">Isi Berita</label>
                        <textarea name="isi" id="isi" rows="10" class="form-control" required maxlength="5000" oninput="updateCharCount('isi', 'isiCount', 5000)"><?= old('isi'); ?></textarea>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="gambar_id" id="gambar_id" class="form-select" onchange="previewGambar()">
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <img id="preview" src="<?= base_url('assets/img/upload/default.jpg') ?>" alt="Preview Gambar" class="img-thumbnail" style="max-height: 300px; max-width: 100%;">
                        </div>
                    </div>
                </div>
            </div>
