...
<div class="card">
    ...
    <div class="card-body overflow-auto">
        ...
        <form action="<?= base_url('admin/prestasi/' . $prestasi->prestasi_id) ?>" method="post">
            <?= csrf_field() ?>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="prestasi" id="prestasi"
                            ...
                            value="<?= old('prestasi', $prestasi->prestasi); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="jenis" id="jenis"
                            ...
                            required>
                            <option value="Prestasi Siswa" <?= old('jenis', $prestasi->jenis) === 'Prestasi Siswa' ? 'selected' : '' ?>>Prestasi Siswa</option>
                            <option value="Prestasi Pengajar" <?= old('jenis', $prestasi->jenis) === 'Prestasi Pengajar' ? 'selected' : '' ?>>Prestasi Pengajar</option>
                            <option value="Prestasi Lembaga" <?= old('jenis', $prestasi->jenis) === 'Prestasi Lembaga' ? 'selected' : '' ?>>Prestasi Lembaga</option>
                        </select>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi" id="deskripsi"
                            ...
                            oninput="updateCharCount('deskripsi', 'deskripsiCount', 5000)"><?= old('deskripsi', $prestasi->deskripsi); ?></textarea>
                        ...
                        <select name="gambar_id" id="gambar_id" 
                            ...
                            <?php foreach ($list_gambar as $gambar): ?>
                                <option value="<?= $gambar->gambar_id ?>" data-nama-file="<?= $gambar->nama_file ?>"
                                    <?= old('gambar_id', $prestasi->gambar_id) == $gambar->gambar_id ? 'selected' : '' ?>>
                                    <?= esc($gambar->judul) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <img id="preview"
                                src="<?= base_url('assets/img/upload/' . ($prestasi->gambar_id ? $list_gambar[array_search($prestasi->gambar_id, array_column($list_gambar, 'gambar_id'))]->nama_file : 'default.jpg')) ?>"
                                alt="Preview Gambar"
