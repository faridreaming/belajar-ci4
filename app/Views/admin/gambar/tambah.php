...
<div class="card">
    ...
    <div class="card-body overflow-auto">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h5 class="card-title">Tambah Gambar Baru</h5>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div>
                            <img id="preview"
                                src="<?= base_url('assets/img/upload/' . (old('gambar_id') && isset($list_gambar) ? $list_gambar[array_search(old('gambar_id'), array_column($list_gambar, 'gambar_id'))]->nama_file : 'default.jpg')) ?>"
                                alt="Preview Gambar"
                                class="img-thumbnail"
